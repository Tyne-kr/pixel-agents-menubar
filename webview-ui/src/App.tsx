...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* Hide zoom buttons in Electron — use mouse wheel instead */}
      {!isDebugMode && !('pixelAgentsAPI' in window) && <ZoomControls zoom={editor.zoom} onZoomChange={editor.handleZoomChange} />}
      ...
      {/* Hide BottomToolbar in Electron — no terminal, read-only observer */}
      {!('pixelAgentsAPI' in window) && (
        <BottomToolbar
          isEditMode={editor.isEditMode}
